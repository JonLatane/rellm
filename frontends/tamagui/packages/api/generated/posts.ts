...
import { Author, MediaReference } from "./media";
...
export const Post: MessageFns<Post> = {
  encode(message: Post, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.media) {
      MediaReference.encode(v!, writer.uint32(82).fork()).join();
    }
    ...
    for (const v of message.replies) {
      Post.encode(v!, writer.uint32(154).fork()).join();
    }
    ...
    if (message.lastActivityAt !== undefined) {
      Timestamp.encode(toTimestamp(message.lastActivityAt), writer.uint32(186).fork()).join();
    }
...
export const GroupPost: MessageFns<GroupPost> = {
  encode(message: GroupPost, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.groupId !== "") {
    ...
    if (message.sharedBy !== undefined) {
      Author.encode(message.sharedBy, writer.uint32(50).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GroupPost {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const UserPost: MessageFns<UserPost> = {
  encode(message: UserPost, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UserPost {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const GetGroupPostsRequest: MessageFns<GetGroupPostsRequest> = {
  encode(message: GetGroupPostsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.postId !== "") {
      writer.uint32(10).string(message.postId);
    }
    if (message.groupId !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetGroupPostsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const GetGroupPostsResponse: MessageFns<GetGroupPostsResponse> = {
  encode(message: GetGroupPostsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.groupPosts) {
      GroupPost.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetGroupPostsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
