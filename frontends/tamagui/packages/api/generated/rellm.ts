 ...
 * ### gRPC API
 */
export type RellmDefinition = typeof RellmDefinition;
export const RellmDefinition = {
  name: "Rellm",
  fullName: "rellm.Rellm",
  methods: {
...
export interface RellmServiceImplementation<CallContextExt = {}> {
  /** Get the version (from Cargo) of the Rellm service. *Publicly accessible.* */
  getServiceVersion(
    request: Empty,
...
export interface RellmClient<CallOptionsExt = {}> {
  /** Get the version (from Cargo) of the Rellm service. *Publicly accessible.* */
  getServiceVersion(
