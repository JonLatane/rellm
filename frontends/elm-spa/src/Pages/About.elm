...
aboutRellmView =
    div [ class "about-rellm" ]
        ...
        , p [] [ text "Its only external requirements are PostgreSQL and an S3-compatible object store. If you have ", pre [] [ text "docker" ], text " and Postgres's ", pre [] [ text "createdb" ], text " it takes about ", a [ href "https://github.com/JonLatane/rellm#2-minute-startup-with-homebrew" ] [ text "2 minutes to set up Rellm on macOS with Homebrew" ], text " or ", a [ href "https://github.com/JonLatane/rellm#3-minute-startup-on-linux" ] [ text "3 minutes to set up Rellm on Linux" ], text "." ]
