...
module Proto.Rellm.CustomNavigationTab exposing (Icon, Target)
...
-}
type alias Icon =
    Proto.Rellm.Internals_.Proto__Rellm__CustomNavigationTab__Icon__Icon
...
-}
type alias Target =
    Proto.Rellm.Internals_.Proto__Rellm__CustomNavigationTab__Target__Target
