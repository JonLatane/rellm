...
module Proto.Rellm.GenerateMediaRequest exposing (Target)
...
{-| What, if anything, the generated image should be attached to (as the _first_ item in its `media` list) once
...
-}
type alias Target =
    Proto.Rellm.Internals_.Proto__Rellm__GenerateMediaRequest__Target__Target
