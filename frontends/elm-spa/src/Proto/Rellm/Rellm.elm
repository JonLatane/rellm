...
module Proto.Rellm.Rellm exposing (accessToken, cancelMarketSubscription, configureServer, createAIProvider, createAccount, createEvent, createFollow, createGroup, createGroupPost, createMarketProduct, createMembership, createNewOccasions, createPost, createSyncDestination, createSyncSource, defederateProfile, deleteAIProvider, deleteEvent, deleteEventAttendance, deleteFollow, deleteGroup, deleteGroupPost, deleteMedia, deleteMediaSizes, deleteMembership, deleteOccasionSyncDestination, deletePost, deletePostSyncDestination, deleteRemovedOccasions, deleteSyncDestination, deleteSyncSource, deleteUser, federateProfile, freeClusterResources, generateMedia, getAIProviders, getCurrentUser, getEventAttendances, getEvents, getGroupPosts, getGroups, getMarketProducts, getMarketSubscriptions, getMedia, getMembers, getMessages, getPosts, getPushSubscriptionStatus, getServerConfiguration, getServiceVersion, getSyncDestinations, getSyncSources, getUsers, grantAIProvider, lockClusterResources, login, makeMarketPurchase, markMessagesRead, registerPushSubscription, resetData, resetPassword, revokeAIProvider, sendMessage, starPost, startContactMethodVerification, syncOccasion, syncPost, unregisterPushSubscription, unstarPost, updateAIProvider, updateEvent, updateEventDetails, updateFollow, updateGroup, updateGroupPost, updateMarketProduct, updateMarketSubscription, updateMedia, updateMembership, updateOccasions, updatePost, updateSyncDestination, updateSyncSource, updateUser, upsertEventAttendance, verifyContactMethod)
...
lockClusterResources :
    Grpc.Internal.Rpc Proto.Rellm.LockClusterResourcesRequest Proto.Rellm.LockClusterResourcesResponse
lockClusterResources =
    Grpc.Internal.Rpc
        { service = "Rellm"
        , package = "rellm"
...
getMarketSubscriptions :
    Grpc.Internal.Rpc Proto.Rellm.GetMarketSubscriptionsRequest Proto.Rellm.GetMarketSubscriptionsResponse
getMarketSubscriptions =
    Grpc.Internal.Rpc
        { service = "Rellm"
        , package = "rellm"
...
deleteOccasionSyncDestination :
    Grpc.Internal.Rpc Proto.Rellm.DeleteOccasionSyncDestinationRequest Proto.Google.Protobuf.Empty
deleteOccasionSyncDestination =
    Grpc.Internal.Rpc
        { service = "Rellm"
        , package = "rellm"
...
getPushSubscriptionStatus :
    Grpc.Internal.Rpc Proto.Rellm.GetPushSubscriptionStatusRequest Proto.Rellm.GetPushSubscriptionStatusResponse
getPushSubscriptionStatus =
    Grpc.Internal.Rpc
        { service = "Rellm"
        , package = "rellm"
