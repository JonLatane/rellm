...
module Proto.Rellm.AIProvider exposing (Provider)
...
An [Anthropic API](https://docs.anthropic.com) connection. _Not yet creatable_ - Anthropic doesn't offer an image generation API.
...
-}
type alias Provider =
    Proto.Rellm.Internals_.Proto__Rellm__AIProvider__Provider__Provider
